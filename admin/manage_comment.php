...
<html lang="en">
  <head>
    ...
    <title>BMS Admin - Manage Comments</title>
    <meta charset="utf-8">
            ...
            <div class="tile-body">
              <div class="table-responsive">
                <table class="table table-hover table-bordered" id="sampleTable">
                  ...
                  <tbody>
<?php 
//$sql="select * from comments ORDER BY `comments`.`cmt_id` DESC";
$sql="select c.*,a.title from comments c,articles a where a.art_id=c.art_id order by `c`.`cmt_id` DESC";
