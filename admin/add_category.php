...
<html lang="en">
  <head>
    ...
    <title>BMS Admin - Add Category</title>
    <meta charset="utf-8">
...
if (isset($_POST['submit']))
 {
  ...
  $sql="select count(*) from category where cat_name='$category'";
  $cnt=ReturnAnyValue($conn,$sql);

    if ($cnt>0) 
    {
      echo "Duplicate Category Name";
    }
    else 
    {
      ...
      if (mysqli_query($conn,$sql))
        ...
        {
          echo "Sorry there was a problem in adding your friend";
          echo "<br>".$sql;
        }
    }
}
...
?>
              ...
              <form class="" method="post" action="">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-1">
                    <input class="form-control" type="checkbox" name="catontop" id="catontop" value="1" >
                  </div>
                </div>
