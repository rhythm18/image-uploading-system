...
<html lang="en">
  <head>
    ...
    <title>BMS Admin - Manage Rejected Comments</title>
    <meta charset="utf-8">
  ...
  <body class="app sidebar-mini">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-dashboard"></i>Manage Rejected Comments</h1>
          <p></p>
        </div>
            ...
            <div class="tile-body">
              <div class="table-responsive">
                <table class="table table-hover table-bordered" id="sampleTable">
                  ...
                  <tbody>
<?php 
$sql="select c.*,a.title from comments c,articles a where cmt_status=0 and a.art_id=c.art_id order by `c`.`cmt_id` DESC";
